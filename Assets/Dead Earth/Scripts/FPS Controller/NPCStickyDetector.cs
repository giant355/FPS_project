...
public class NPCStickyDetector : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {
            _controller.DoStickyiness();
            machine.VisualThreat.Set(AITargetType.Visual_Player, _controller.characterController, _controller.
                                     transform.position, Vector3.Distance(machine.transform.position, _controller.transform.position));
